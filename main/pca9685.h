...
#define PCA9685_SERVO_MIN_COUNT 102   // ~0.5 ms pulse -> 0 deg
#define PCA9685_SERVO_MAX_COUNT 512   // ~2.5 ms pulse -> 180 deg

// Initialise PCA9685 on an existing I2C bus.
...
// Read MODE1, MODE2, PRE_SCALE and a channel's OFF registers for diagnostics.
